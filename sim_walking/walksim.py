...
def main():
	...
	rospy.init_node('stair_path_planner', anonymous=walk)
	rospy.Subscriber("stairs", String, walk)
	...
	def walk(message):
		...
		for i in range(0, int(stair_count)):
			...
			self.fsubject.set_foot(foot[0], foot_pos[0]+ h , foot_pos[1], foot_pos[2] + (r * 0.75));	
